...
from src.features import other_gather_features
...
def model():
    ...
    X_train, X_test, y_train, y_test, X_scaler = other_gather_features(cars,not_cars)
    print(u'\u2713', 'Done!\n')
    ...
    joblib.dump(X_scaler, 'model1/Xscaler.pkl')
