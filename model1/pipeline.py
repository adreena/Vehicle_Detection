...
def pipeline(image, file_name=''):
    ...
    if sequence is False:
        ...
        plt.title('Heat Map')
        fig.savefig('model1/output_images/{}.jpg'.format(file_name))
...
if __name__ == "__main__":
    vehicles = []
    svc = pickle.load( open( "model1/model.p", "rb" ) )
    X_scaler = joblib.load('model1/Xscaler.pkl')
    print(u'\u2713', 'Loaded Model & X_scaler!\n')

    sequence = False
    print('.................test3...................')
    o1= pipeline(mpimg.imread('test_images/test3.jpg'), file_name='test3')
    mpimg.imsave("model1/output_images/output_test3.jpg", o1)
    print('\n')
    print('.................test2...................')
    o1=pipeline(mpimg.imread('test_images/test2.jpg'), file_name='test2')
    mpimg.imsave("model1/output_images/output_test2.jpg", o1)
    print('\n')
    print('.................test4...................')
    o1=pipeline(mpimg.imread('test_images/test4.jpg'), file_name='test4')
    mpimg.imsave("model1/output_images/output_test4.jpg", o1)
    print('\n')
    print('.................test5...................')
    o1=pipeline(mpimg.imread('test_images/test5.jpg'), file_name='test5')
    mpimg.imsave("model1/output_images/output_test5.jpg", o1)
    print('\n')
    print('.................test6...................')
    o1=pipeline(mpimg.imread('test_images/test6.jpg'), file_name='test6')
    mpimg.imsave("model1/output_images/output_test6.jpg", o1)
    ...
    vehicles = []
    sequence = True
    video_output = 'model1/project_output.mp4'
