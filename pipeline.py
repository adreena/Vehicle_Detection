...
def pipeline(image, file_name=''):
    ...
    draw_image = adjust_gamma(np.copy(image), gamma=1.0)
...
#     image_display(heatmap)
    ...
    if sequence is False:
        ...
        plt.title('Heat Map')
        fig.savefig('output_images/{}.jpg'.format(file_name))
...
if __name__ == "__main__":
    vehicles = []
    svc = pickle.load( open( "model2.p", "rb" ) )
    X_scaler = joblib.load('Xscaler2.pkl')
    ...
    mpimg.imsave("output_images/output_test2.jpg", o1)
    print('\n')
    print('.................test4...................')
    ...
    vehicles = []
    sequence = True
    video_output = 'project_output2.mp4'
